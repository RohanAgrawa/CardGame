...
public class GamePlay {
    ...
    public void playGame() throws Exception{
        ...
        while (true) {
            ...
            int matchedNumber = -1;
            Card topDiscardCard = discardPile.get(discardPile.size() - 1); // top card of the discard pile with whom the player will try to match his cards.
            ...
            if (matched == false) {
                System.out.println("No cards match for player " + players.get(playerTurn).giveId() + " Taking " + numCardsTake + " Card(s)");
